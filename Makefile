...
main : a_stern.cpp  CoordinateGraph.o unit.o maze.o  MazeVisualizer.o c_graph_visualizer.o
	$(CXX) $(FLG)   -g -o $@ $^ $(LIBS)
...
run: main
	export LD_LIBRARY_PATH=./Visualizer.cpp/test_b/lib/SFML-2.5.0/lib &&./main 1 0
gdb: main
